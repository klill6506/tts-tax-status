...
- [~] **20c · Form 2848** — Power of Attorney (print-first). RS greenfield spec → tts print
  unit (per-preparer CAF autofill from the Preparer record is the value-add). **RS draft
  COMPLETE 2026-07-12 (WO-27, harness 73/0) — ⏳ AWAITING KEN's Gate-1; NOT seeded; the
  tts print unit dispatches on approval (pairs with 20b's).**
