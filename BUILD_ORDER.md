...
- [~] **20b · Form 2553** — S-election (print-first; no annual reissue). RS greenfield spec
  ...
  **RS draft COMPLETE 2026-07-12 (WO-26, harness 82/0) — ⏳ AWAITING KEN's Gate-1; NOT
  seeded; the tts print unit dispatches on approval.**
- [ ] **20c · Form 2848** — Power of Attorney (print-first). RS greenfield spec → tts print
  unit (per-preparer CAF autofill from the Preparer record is the value-add). Gap
  re-confirmed 404 (2026-07-12) — same draft-to-gate recipe as 2553.
