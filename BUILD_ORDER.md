...
## ▶ NOW WORKING ON — **S-19 usability batch 1 — resume at item 16 (CC retrospective, the LAST batch-1 item)** (`USABILITY_QUEUE.md` in the tax-app root is the checklist; s38 shipped 1/4/7/13/13b/15 + the parity gate + L3a RS `R008`; s39 shipped 11 · 2 · 3 · 5 + the dead "+ Add" fix (mig 0181); s40 shipped 6 · 8+14 · G-a; s41 shipped 9 — the M&E four-tier unit (tts `d8dbeba` / RS `96931bf`); **s42 shipped 12 — Schedule B Q11 auto-answer, spec-first end-to-end (tts `94380af` / RS `b7907bc`): RS 1120S_SCHB RENUMBERED to the verified 2025 face (the old block was a fabricated pre-face numbering — its "B11" = an AE&P question that isn't on the face; stale line/fact rows deleted in-loader) + NEW R006 (derived/YELLOW/overridable per the Ken ruling; Schedule L/M-1 behavior and diagnostics unchanged) + verbatim i1120s (2025) p.24 total-receipts excerpt; tts `_auto_answer_b11_db` after the 1120-S formula pass (positive-only component sum + computed L15d; override-respecting write) + amber "Auto" pill/chips client-side (1120-S scoped — the 1065's unrelated B11 untouched); 5 DB tests · flow 447 · MeF 64 · S5+S6 scenarios 8/8 · parity fixture byte-identical · vitest 278 · tsc 0 · live probe verified (derived Yes → No click → override survives recompute), probe cascade-deleted; 3 REVIEW_QUEUE items (1065 Sch B Q4 sibling needs its own Ken ruling · the two interpretive readings · SCHB renumber ratification)**. Remaining: **16 (CC retrospective — LAST)** · 10 (Ken-gated: Lacerte reprint of file 1018); batch 2 arrives from Ken when batch 1 closes). The 1120-S ATS completion lane stays Ken-gated: **e-services email OUT 2026-07-09** (S7/S8 ruling · 8941 key-inversion [Ken RATIFIED the finding — engine right, key wrong] · 1040 production flip · SOR re-request) → any S7/S8 builds → full-set bundle → the live upload loop. A2A (17g): IdenTrust packet OVERNIGHTED 2026-07-09, cert vetting ~7-14 days (⚠ 30-day download clock from notarization); AE values pre-agreed in `docs/mef/A2A_ENROLLMENT.md`. S-18: PWA CODE-COMPLETE (Ken install-verify pending) · 18f prefs DONE · 18a/18b/18g queued · 18d parked.
