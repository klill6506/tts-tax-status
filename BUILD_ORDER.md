...
- [x] `[RS+APP]` **Depreciation-methods unit COMPLETE, spec-first** — 2026-07-10 RS
  ...
  (refuse seam) · 280F on AMT/state parallels · UOP/ACRS scope = Ken ruling.
